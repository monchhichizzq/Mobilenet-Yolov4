...
if __name__ == "__main__":
    ...
    train_annotation_path = '../preparation/data_txt/VOC_2007_train.txt'
    val_annotation_path = '../preparation/data_txt/VOC_2007_val.txt'
    #-------------------------------#
    #   获得先验框和类
    #-------------------------------#
    ...
    model_path = "../models/original/yolo4_voc_weights.pth"
    # 加快模型训练的效率
